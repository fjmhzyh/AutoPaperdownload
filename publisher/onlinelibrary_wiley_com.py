...
class OnlinelibraryWileyComLoginHandler(PublisherLoginHandler):
    domain = "onlinelibrary.wiley.com"
    handler_name = "onlinelibrary_wiley_com"

    def login(self, domain: str, ctx: LoginContext) -> bool:
        ctx.log("[登录] 执行onlinelibaray_Wiley_com登录流程")
...
def get_handler() -> PublisherLoginHandler:
    return OnlinelibraryWileyComLoginHandler()
