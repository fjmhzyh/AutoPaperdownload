...
class AicheWileyComLoginHandler(PublisherLoginHandler):
    domain = "aiche.onlinelibrary.wiley.com"
    handler_name = "aiche_onlinelibrary_wiley_com"
...
def get_handler() -> PublisherLoginHandler:
    return AicheWileyComLoginHandler()
